 ...
 * shuffle for arrays of all primitive data types, as well as of {@link Object}. Shuffling is done in-place&mdash; that is, the methods don't return copies of the original arrays, but instead modify the contents of those arrays directly.
 */
...
public class Shuffler {
  ...
  /**
   * Initializes this instances, using the provided source of randomness.
   *
  ...
  public boolean hasTeen(int a, int b, int c) {
    ...
    result = (a >= 13 && a <= 19) || (b >= 13 && b <= 19) || (c >= 13 && c <= 19);
